...
def varAssign():
    licenseID = 5739457398
    print(type(licenseID))
    name = "Person X"
    print(type(name))
    dob = "17 November 2017"
    print(type(dob))
    pincode = 385738
    print(type(pincode))
    address = "California, USA"
    print(type(address))
    vehicle_type = ["Two Wheeler", "Four Wheeler", "Jeep", "SUV", "Van"]
    print(type(vehicle_type))
    
    label_id["text"] = licenseID
...
button1 = Button(root, text = "show license", command = varAssign)
